                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                 data-placement="bottom" data-original-title="{{ $history['email'] }}">
                                                <div class="badge badge-pill badge-info">{{ $history['name'] }}</div>
                                            </div>
                                        </td>
                                        <td>
                                            @if($history['hanhdong'] == 'Xuất kho')
                                                <a href="{{ url('xuatkho') }}/{{ $history['thongtin'] }}">{{ $history['hanhdong'] }}</a>
                                            @endif
                                            @if($history['hanhdong'] == 'Nhập kho')
                                                <a href="{{ url('lichsunhap') }}/{{ $history['thongtin'] }}">{{ $history['hanhdong'] }}</a>
                                            @endif
                                            @if($history['hanhdong'] == 'Xác nhận đơn hàng' || $history['hanhdong'] == 'Hoàn tất giao hàng' || $history['hanhdong'] == 'Nhận giao đơn hàng')
                                                <a href="{{ url('delivery') }}?id={{ $history['thongtin'] }}">{{ $history['hanhdong'] }}</a>
                                            @endif
